...
namespace DocumentArchival.Migrations
{
    ...
    [Migration("20240603093946_fil08updatedBy-nullable")]
    partial class fil08updatedBynullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DocumentArchival.Models.fil02document_detail", b =>
                {
                    ...
                    b.Property<string>("fil02doctype")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DocumentArchival.Models.fil03attach_document", b =>
                {
                    ...
                    b.Property<string>("fil03category")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
